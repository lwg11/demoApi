...
//分页列表
const findPageList = (params,findOptions,limit)=>{
  return Promise.all([sqlPromise(model.recordCount(findOptions),params),sqlPromise(model.findPageList(findOptions,limit),[...params,limit])])
};
